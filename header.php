  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <h5><a class="nav-link" href="home">Home <span class="sr-only">(current)</span></a></h5>
      </li>
      <li class="nav-item">
		  <h5><a class="nav-link" href="blog">Blogs</a></h5>
      </li>
      <li class="nav-item">
        <h5><a class="nav-link" href="contact">Contact us</a></h5>
      </li>
    </ul>
  </div>
</nav>
