	...
	<div class="gallery-format clr">
		...
		foreach ( $attachments as $attachment ) :
			...
			if ( OCEAN_EXTRA_ACTIVE
				...
				$attachment_html = '' . ocean_extra_resize( $img_url[0], $img_atts['width'], $img_atts['height'], $img_atts['crop'], true, $img_atts['upscale'] ) . '" alt="' . $attachment_alt . '" width="' . $img_width . '" height="' . $img_height . '" itemprop="image" />';
